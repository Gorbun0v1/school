...
public class FacultyController {
    ...
    public ResponseEntity<List<Faculty>> filterFindByColorOrName(@RequestParam(value = "color", required = false) String color, @RequestParam(value = "name", required = false) String name) {
